...
const floorZones = [
  {
    floorNum: 4,
    label: "4. NP",
    points: "1274.04,448.57 1272.61,641.19 1767.06,738.22 1870.53,644.41 1880.55,557.05 1883.77,546.67 1940.34,417.78 1951.09,391.64 1981.52,325.76 1631.72,288.88",
  },
  {
    floorNum: 3,
    label: "3. NP",
    points: "1272.61,641.19 1767.06,738.22 1870.53,644.41 1854.48,791.23 1751.35,892.93 1270.79,783.4",
  },
  {
    floorNum: 2,
    label: "2. NP",
    points: "1270.79,783.4 1751.35,892.93 1854.48,791.23 1841.72,901.75 1562.89,1211.62 1290.54,1131.49 1491.46,950.31 1269.82,896.61",
  },
];
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="sticky top-28">
              ...
              <div className="relative w-full overflow-hidden bg-cream">
                <Image
                  src="/images/vizualizace-nove/mapa.webp"
