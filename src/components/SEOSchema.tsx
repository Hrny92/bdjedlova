...
export default function SEOSchema() {
  ...
  const website = {
    ...
    description:
      "Bytový dům Jedlová — 8 prémiových bytů v centru Plzně. Dispozice 1+kk až 3+kk penthouse. Fasáda z betonu a dřevěných lamel. Cena od 3 530 000 Kč.",
    inLanguage: "cs-CZ",
  ...
  const apartmentComplex = {
    ...
    name: "BD Jedlová",
    description:
      "Prémiový bytový dům v centru Plzně. Čtyři nadzemní podlaží, 8 bytových jednotek dispozic 1+kk, 3+kk a penthouse. Fasáda z betonu a dřevěných lamelových prvků. Každý byt má sklepní kóji a parkovací místo v krytém parkovišti.",
    url: BASE_URL,
    address: {
      "@type": "PostalAddress",
      streetAddress: "Jedlová",
    ...
    amenityFeature: [
      ...
      { "@type": "LocationFeatureSpecification", name: "Beton", value: true },
  ...
  const faqPage = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Cena za metr čtvereční v BD Jedlová je 125 000 Kč. Tato cena odpovídá prémiové novostavbě v centru Plzně s vysokým standardem provedení a architektonicky hodnotnou fasádou z betonu.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "BD Jedlová se vyznačuje výraznou fasádou z betonu doplněnou dřevěnými lamelovými prvky a prosklenými balkóny. Architektonický návrh pochází ze studia Project Studio 8. Dům uzavírá historickou proluku v centru Plzně a svým charakterem respektuje okolní zástavbu.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "BD Jedlová je jednou z mála prémiových novostaveb přímo v historickém centru Plzně. Nabízí 8 bytových jednotek od 28 m² do 100 m² za ceny od 3 530 000 Kč. Jde o architektonicky hodnotnou stavbu s fasádou z betonu — ojedinělý projekt v rámci plzeňského realitního trhu.",
        },
      },
    ],
  };
  ...
  const realEstateListing = {
    ...
    description:
      "8 prémiových bytů k prodeji v novostavbě BD Jedlová v centru Plzně. Dispozice 1+kk (28–54 m²) a 3+kk (59–100 m²). Fasáda beton + dřevo. Parkovací místo a sklepní kója v ceně.",
    url: `${BASE_URL}/byty`,
    image: `${BASE_URL}/images/vizualizace-nove/Ext 1 1.webp`,
